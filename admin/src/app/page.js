    ...
    const loadPackages = async () => {
      ...
      try {
        ...
        const transformedPackages = data.map((pkg) => ({
          ...
          origin: pkg.origin || pkg.sender?.address || "",
          destination: pkg.destination || pkg.receiver?.address || "",
          status: pkg.status,
  ...
  const handleAddPackage = async (packageToAdd = newPackage) => {
    try {
      ...
      const packageWithId = {
        ...
        origin: createdPackage.origin || createdPackage.sender?.address || "",
        destination: createdPackage.destination || createdPackage.receiver?.address || "",
  ...
  const handleAddEvent = async (packageId, newEvent) => {
    try {
      ...
      const transformedPackage = {
        ...
        origin: updatedPackage.origin || updatedPackage.sender?.address || "",
        destination: updatedPackage.destination || updatedPackage.receiver?.address || "",
              ...
              onSave={async (updatedPackage) => {
                try {
                  ...
                  const transformedPackage = {
                    ...
                    origin: updated.origin || updated.sender?.address || "",
                    destination: updated.destination || updated.receiver?.address || "",
